            ...
            <div className="flex h-full">
              ...
              <div className="px-10 w-[50%] py-10 text-center ">
                ...
                <p className="text-center">
                  By signing up or continuing to use Plex you confirm that
                ...
                <button className="w-full px-4 py-2 bg-[#F50000] hover:bg-[#f50000b2] text-white rounded-md">Sign In</button>
              </div>
